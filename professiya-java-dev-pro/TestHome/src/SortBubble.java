public class SortBubble {     ////МЕТОД ПУЗЫРЬКОВОЙ СОРТИРОВКИ

    private final long[] a;   //ссылка на массив
    private int elems;  //количество элементов в массиве

    public SortBubble(int max){    //конструктор класса
    ...
    public static void bubbleSort() {
        SortBubble array = new SortBubble(5); //Создаем массив array на 5 элементов
