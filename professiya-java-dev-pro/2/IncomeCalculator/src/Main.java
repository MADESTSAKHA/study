...
//            int income = (new Scanner(System.in)).nextInt();
            ...
            if (pureIncomeAfterTax >= minInvestmentsAmount) {
                System.out.println("\n\tВсе бля! Компания может инвестировать: " + ANSI_GREEN + income + ANSI_RESET);
                break;
            }

            System.out.println("Введенно средств: " + ANSI_RED + income + ANSI_RESET);
            ...
            System.out.println("Компания может инвестировать: " +
                    (canMakeInvestments ? "да" : (ANSI_BLUE + "нет" + ANSI_RESET)));
            if (pureIncome < 0) {
